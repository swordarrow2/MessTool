...
final class DecodeThread extends Thread {
    ...
    private final ReadBarcodeCameraActivity activity;
    private final ConcurrentHashMap<DecodeHintType, Object> hints;
    private final CountDownLatch handlerInitLatch;
    private Handler handler;

    DecodeThread(ReadBarcodeCameraActivity activity, Vector<BarcodeFormat> decodeFormats, String characterSet, ResultPointCallback resultPointCallback) {
