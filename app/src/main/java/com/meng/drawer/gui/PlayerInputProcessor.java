...
//            vct2_downPosPlayer.set(MyPlaneReimu.instance.objectCenter);
//        }
//        if (pointer == 1) {
...
//            MyPlaneReimu.instance.objectCenter.set(vct2_downPosPlayer).add(vct2_tmp1.sub(vct2_downPosStage));
//        }
