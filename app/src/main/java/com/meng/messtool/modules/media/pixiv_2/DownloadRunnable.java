...
class DownloadRunnable implements Runnable {
    ...
    private PixivProgressBar mengProgressBar;
    ...
    public PojoPainting pojoPainting;
    private String title = "pids";

    public DownloadRunnable(PixivProgressBar mengProgressBar, String picUrl, String absolutePath, ListView listView, PojoPainting pijb) {
    ...
    public void run() {
        ...
        if (pojoPainting.isAnimPicture) {
            ...
            setProgressBarFileName(pojoPainting.id + ".gif");
            ...
            try {
                ...
                List<PojoAnimPainting.Body.Frames> lf = pojoPainting.pojoAnimPainting.body.frames;
                int i = 0;
                while (ze != null) {
                    filesNow++;
        ...
        PixivDatabase.getInstance().deleteFailedId(picUrl);
        downloadEnd();
    }
