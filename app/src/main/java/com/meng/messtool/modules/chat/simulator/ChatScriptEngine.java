    ...
    public void processAction(ChatScriptAdapter.ViewHolder viewHolder, ChatScriptAction action) {
        ...
        switch (action.action) {
            ...
            case TYPE_IMAGE_MESSAGE:
                ...
                msp.setSpan(new ImageSpan(context, BitmapFactory.decodeFile(FileTool.getAppFile(FunctionSavePath.chat_image, action.content).getAbsolutePath())), 0, action.content.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
