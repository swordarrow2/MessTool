...
public class AndroidContent {
    ...
    public static int px2dp(float pxValue) {
        return (int) (pxValue / ApplicationHolder.getActivity().getResources().getDisplayMetrics().density + 0.5f);
    }

    public static int dp2px(float dipValue) {
        return (int) (dipValue * ApplicationHolder.getActivity().getResources().getDisplayMetrics().density + 0.5f);
    }

    public static int px2sp(float pxValue) {
        return (int) (pxValue / ApplicationHolder.getActivity().getResources().getDisplayMetrics().scaledDensity + 0.5f);
    }

    public static int sp2px(float spValue) {
        float fontScale = ApplicationHolder.getActivity().getResources().getDisplayMetrics().scaledDensity;
        return (int) (spValue * fontScale + 0.5f);
    }

    public static void copyToClipboard(String s) {
        ((ClipboardManager) ApplicationHolder.getActivity().getSystemService(Context.CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("text", s));
