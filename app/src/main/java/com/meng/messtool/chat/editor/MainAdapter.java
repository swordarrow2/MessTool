    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (action.action) {
            ...
            case TYPE_IMAGE_MESSAGE:
                ...
                msp.setSpan(new ImageSpan(ctx, BitmapFactory.decodeFile(FileTool.getAppFile(FunctionSavePath.chat_image, action.content).getAbsolutePath())), action.from.length() + 1, msp.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
