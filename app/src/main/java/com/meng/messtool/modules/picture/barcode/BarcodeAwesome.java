...
public class BarcodeAwesome extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.picture_barcode_awesome_qr_main, container, false);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.awesomeqr_mainButton_save:
                try {
                    String s = FileTool.saveToFile(FileTool.getAppFile(FileSavePath.AWESOME_QR, FileTool.FileType.png), bmpQRcode);
                    showToast("已保存至" + s);
